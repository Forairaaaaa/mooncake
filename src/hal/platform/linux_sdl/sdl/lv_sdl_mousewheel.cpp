...
{
    lv_sdl_mousewheel_t * dsc = (lv_sdl_mousewheel_t *)lv_malloc(sizeof(lv_sdl_mousewheel_t));
...
static void sdl_mousewheel_read(lv_indev_t * indev, lv_indev_data_t * data)
{
    lv_sdl_mousewheel_t * dsc = (lv_sdl_mousewheel_t *)lv_indev_get_driver_data(indev);
