...
{
    lv_sdl_mouse_t * dsc = (lv_sdl_mouse_t *)lv_malloc(sizeof(lv_sdl_mouse_t));
...
static void sdl_mouse_read(lv_indev_t * indev, lv_indev_data_t * data)
{
    lv_sdl_mouse_t * dsc = (lv_sdl_mouse_t *)lv_indev_get_driver_data(indev);
...
void _lv_sdl_mouse_handler(SDL_Event * event)
{
    ...
    lv_sdl_mouse_t * indev_dev = (lv_sdl_mouse_t *)lv_indev_get_driver_data(indev);
